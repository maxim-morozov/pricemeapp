"""
Django settings for pricemeapp project.
...
SECRET_KEY = 'hjd1f8o-qyt%w$eb+e^9lav*jow6xelvs@eh%qloj0^p-be96+'
...
WSGI_APPLICATION = 'pricemeapp.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'pricemealbum.db'),
    }
}
